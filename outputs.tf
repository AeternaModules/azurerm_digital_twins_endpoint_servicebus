output "digital_twins_endpoint_servicebuses_id" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.id if v.id != null && length(v.id) > 0 }
}
output "digital_twins_endpoint_servicebuses_dead_letter_storage_secret" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.dead_letter_storage_secret if v.dead_letter_storage_secret != null && length(v.dead_letter_storage_secret) > 0 }
  sensitive   = true
}
output "digital_twins_endpoint_servicebuses_digital_twins_id" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.digital_twins_id if v.digital_twins_id != null && length(v.digital_twins_id) > 0 }
}
output "digital_twins_endpoint_servicebuses_name" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.name if v.name != null && length(v.name) > 0 }
}
output "digital_twins_endpoint_servicebuses_servicebus_primary_connection_string" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.servicebus_primary_connection_string if v.servicebus_primary_connection_string != null && length(v.servicebus_primary_connection_string) > 0 }
  sensitive   = true
}
output "digital_twins_endpoint_servicebuses_servicebus_secondary_connection_string" {
  ...
  value       = { for k, v in azurerm_digital_twins_endpoint_servicebus.digital_twins_endpoint_servicebuses : k => v.servicebus_secondary_connection_string if v.servicebus_secondary_connection_string != null && length(v.servicebus_secondary_connection_string) > 0 }
  sensitive   = true
}
