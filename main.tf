data "azurerm_key_vault_secret" "servicebus_primary_connection_string" {
  for_each     = { for k, v in var.digital_twins_endpoint_servicebus : k => v if v.servicebus_primary_connection_string_key_vault_id != null && v.servicebus_primary_connection_string_key_vault_secret_name != null }
...
data "azurerm_key_vault_secret" "servicebus_secondary_connection_string" {
  for_each     = { for k, v in var.digital_twins_endpoint_servicebus : k => v if v.servicebus_secondary_connection_string_key_vault_id != null && v.servicebus_secondary_connection_string_key_vault_secret_name != null }
...
data "azurerm_key_vault_secret" "dead_letter_storage_secret" {
  for_each     = { for k, v in var.digital_twins_endpoint_servicebus : k => v if v.dead_letter_storage_secret_key_vault_id != null && v.dead_letter_storage_secret_key_vault_secret_name != null }
